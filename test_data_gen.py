...
dataset_path = "/mnt/e/datasets/PSCC/Training Dataset/CASIA2.0/fake_256"
...
# 记录带相对路径的文件名，比如 fake/xxx.jpg
sampled_files.extend([os.path.join(dataset_path, f) for f in sampled])

# 保存文件名到文本文件
save_path = "CASIA2.0.txt"
