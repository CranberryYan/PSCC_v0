...
def test(args):
    ...
    # =================== 加载 checkpoint ===================
    ckpt_path = "./total=15000_epochs=100_batch=6_with_MoE=True(MoE_attn=CBAM_K=2)_with_HiLo=True/checkpoint/NLCDetection_checkpoint/NLCDetection_best.pth"
