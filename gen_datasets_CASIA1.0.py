...
def main():
    ap = argparse.ArgumentParser(description="Make CASIA1.0 dataset (fake/mask) + txt lists.")
    ap.add_argument("--fake-root", default=r"/mnt/c/Users/Administrator/Downloads/CASIA1.0/Modified Tp/Tp",
                    help="CASIA fake(Tp) 根目录")
    ap.add_argument("--mask-root", default=r"/mnt/c/Users/Administrator/Downloads/CASIA1.0_GT/CASIA 1.0 groundtruth",
                    help="CASIA GT(mask) 根目录")
    ap.add_argument("--out-root", default=r"/mnt/e/datasets/PSCC/Training Dataset/CASIA1.0",
